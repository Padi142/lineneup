...
class _ArtistApi implements ArtistApi {
  ...
  Future<ArtistListDto> getEventArtists(id) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<ArtistListDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ArtistPhotoUploadApiResponse> artistPhotoUpload(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<ArtistPhotoUploadApiResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
